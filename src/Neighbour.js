...
//const linkedCountry = CountriesData.filter((country) => country.name === match.params.name);
const linkedCountry = CountriesData.filter((element) => element.alpha3Code === border);
return (
<Fragment>
<div>
